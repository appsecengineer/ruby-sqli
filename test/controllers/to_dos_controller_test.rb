...
class ToDosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create to_do" do
    assert_difference("ToDo.count") do
      post to_dos_url, params: { to_do: { date_to_be_completed: @to_do.date_to_be_completed, name: @to_do.name, remarks: @to_do.remarks } }
    end
  ...
  test "should update to_do" do
    patch to_do_url(@to_do), params: { to_do: { date_to_be_completed: @to_do.date_to_be_completed, name: @to_do.name, remarks: @to_do.remarks } }
